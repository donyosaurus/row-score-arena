-- Atomic contest entry function with row locking to prevent race conditions
...
BEGIN
  ...
  -- 1. Insert ledger entry (negative amount for fee)
  ...
  -- 3. Increment current_entries in contest_pools
