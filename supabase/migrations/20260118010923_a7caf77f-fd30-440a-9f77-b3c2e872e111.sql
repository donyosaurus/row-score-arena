-- Fix admin_update_race_results to use valid status 'settling' instead of 'scoring_processing'
...
BEGIN
  ...
  -- Update contest pool status to 'settling' (valid status for processing results)
